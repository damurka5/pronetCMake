...
public:
    ...
    int q0_su[4] = { 13923, 11202, 16636, 15395 }; // in servo units
    int l0[4] = {3697, 3697, 3697, 3697 }; // in mm
    int dq[4] = {0, 0, 0, 0};
	...
	Kinematics(double x1=-1154, double y1=-1404, double x2=1154, double y2=-1404, double x3=1154, double y3=1404, double x4=-1154, double y4=1404, double z=3220);
	~Kinematics();
